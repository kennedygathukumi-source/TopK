...
use backend\models\LabResults;

/**
 * LabResultsSearch represents the model behind the search form of `backend\models\LabResults`.
 */
class LabResultsSearch extends LabResults
{
    ...
    public function rules()
    {
        return [
            ...
            [['findings', 'result_date', 'created_at', 'updated_at'], 'safe'],
        ];
    }
